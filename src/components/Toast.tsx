...
const toastVariants = {
  default: "bg-green-400 mx-5 rounded",
  ...
  return (
    <Animated.View
      className={`
        ...
        m-2 mb-1 p-4 transform transition-all  mx-10
      `}
      style={{
        opacity,
        transform: [
    ...
    >
      <Text className="font-bold text-left text-black px-5 mt-5">
        {message}
      </Text>
      {showProgress && (
        <View className="mt-2 rounded">
          <Animated.View
            className="bg-white dark:bg-black h-2 opacity-80 rounded"
            style={{
